...
#region HotKey Constants
	...
	internal static extern Int16 GlobalDeleteAtom ( 
		Int16 nAtom);
	
	[DllImport("user32.dll", SetLastError=true)]
	internal static extern Int32 RegisterHotKey ( 
		IntPtr hwnd,
		Int32 id,
		Int32 fsModifiers,
		Int32 vk);
	...
	[DllImport("user32.dll", SetLastError=true)]
	internal static extern IntPtr SetClipboardViewer(
		IntPtr hWnd);
